    ...
    <div className="min-h-screen text-white bg-[#1E1118]">
      ...
      <div className="w-full px-4 py-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h1 className="text-5xl sm:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-rose-100 to-rose-200">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/15 transition-colors">
            <button
            ...
            >
              <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-colors ${hideWatched ? 'bg-rose-500 border-rose-400' : 'border-gray-400'}`}>
                {hideWatched && (
